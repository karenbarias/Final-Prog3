...
namespace Final.Controllers
{
    public class PermisosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Empleado,Desde,Hasta,CorrespondienteA,Comentarios")] Permisos permisos)
        {
            ...
            ViewBag.Empleado = new SelectList(db.Empleados, "ID", "CodigoEmpleado", permisos.Empleado);
            return View(permisos);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Empleado,Desde,Hasta,CorrespondienteA,Comentarios")] Permisos permisos)
        {
            if (ModelState.IsValid)
            {
